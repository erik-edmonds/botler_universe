...
def Header(name, app):
    ...
    logo = html.Img(
        src=app.get_asset_url("botler.png"), style={"float": "right", "height": 100}
    )
    link = html.A(logo, href="https://github.com/erik-edmonds/botler_universe")
...
app.title = "Botler: Sensor Fusion Visualization"
server = app.server
    ...
    [
        ...
        dbc.Card(
            dcc.Markdown(
                dedent(
                    """
            This application is for visualizations of a group of common autonomous datasets, as well as a 
            an environment for BOTler. The source code is available [here](https://github.com/erik-edmonds/botler_universe).
            """
                )
            ),
            body=True,
...
app.layout = dbc.Container(
    [
        Header("Botler: Sensor Fusion Visualization Demo", app),
        html.Hr(),
        dbc.Row(
            [
                dbc.Col(
